            ...
            <div class="overflow-hidden sm:rounded-lg">
                ...
                <div class='overflow-x-auto w-full'>
                    <button class="flex bg-black text-white px-4 py-2 my-4 float-right rounded">
                        <a href="/admin/category/create"> {{ __('Add Category') }}</a>
                    </button>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="{{route('admin.categories.edit', ['id'=>$category->id] )}}" class="text-purple-800 hover:underline">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="{{route('admin.categories.destroy', $category->id)}}" class="text-purple-800 hover:underline">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
