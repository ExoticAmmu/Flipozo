                                    ...
                                    @foreach ( $categories as $category )
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{route('admin.categories.edit', ['id'=>$category->id] )}}" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-green-500" title="Edit">
                                                ...
                                                <a href="{{route('admin.categories.destroy', $category->id)}}" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
