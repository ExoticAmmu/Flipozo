    ...
    <div class="mx-auto p-2 w-full lg:w-3/4">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">Edit Category</p>
            </div>
                    ...
                    <div class="relative">
                        <div class="mb-8">
                            <div class="bg-white dark:bg-opacity-20 dark:border-gray-800">
                                <form action="{{ route('admin.categories.edit', $category->id) }}" method="POST" class="flex flex-wrap flex-row -mx-4">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                        ...
                                        <input type="text"
                                            class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                            name="slug" value="{{ $category->slug }}" id="slug">
                                    </div>
                                    <div class="flex-shrink max-w-full px-4 w-full mb-6">
                                        <label for="text" class="inline-block mb-2">Description </label>
                                        <textarea
                                            class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                            name="description" value="{{ $category->description }}" id="description" rows="3"></textarea>
                                    </div>
                                    <div class="flex-shrink max-w-full px-4 w-2/3 mb-6">
                                        ...
                                        <img src="{{ asset('assets/uploads/category/' . $category->image) }}" width="25%"
                                            alt="">
                                    </div>
                                    ...
                                    <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                        ...
                                        <input type="text"
                                            class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                            name="meta_title" value="{{ $category->meta_title }}" id="meta_title">
                                    </div>
                                    <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                        <label for="metaKeyword" class="inline-block mb-2">Meta Keyword</label>
                                        <input type="text"
                                            class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                            name="meta_keyword" value="{{ $category->meta_keyword }}" id="meta_keyword">
                                    </div>
                                    <div class="flex-shrink max-w-full px-4 w-full mb-6">
                                        <label for="metaDescription" class="inline-block mb-2">Meta Description </label>
                                        <textarea
                                            class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                            name="meta_description" value="{{ $category->meta_description }}" id="meta_description" rows="3"></textarea>
                                    </div>
                                    <div class="flex-shrink max-w-full px-4 w-full text-right">
                                        <button type="submit"
                                            class="py-2 px-4 inline-block text-center rounded leading-5 text-gray-100 bg-indigo-600 border border-indigo-600 hover:text-white hover:bg-indigo-700 hover:ring-0 hover:border-indigo-700 focus:bg-indigo-500 focus:border-indigo-500 focus:outline-none focus:ring-0">Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
