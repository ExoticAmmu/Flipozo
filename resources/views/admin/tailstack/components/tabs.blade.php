                        ...
                        <div class="relative">
                            <div class="my-6">
                                <p class="leading-relaxed font-light text-lg mx-auto pb-2">Documentation and examples
                                    for how to use tabs with Alpine js.</p>
                            </div>

                            <div class="mb-12">
                                <h2 class="text-lg mb-6 font-semibold text-gray-800 dark:text-gray-300">Example tabs
                                </h2>
                                ...
                                <div
                                    ...
                                    <div x-data="{ tabs: 1 }" class="p-6">
                                        ...
                                        <div class="w-full pt-4">
                                            <div x-show="tabs === 1">
                                                <p>Placeholder content for the tab panel. This one relates to the home
                                                    ...
                                                    Tone, tan fit and ready, turn it up cause its gettin' heavy. Her
                                                    love is like a drug. I guess that I forgot I had a choice.</p>
                                            </div>
                                            <div x-show="tabs === 2">
                                                <p>Placeholder content for the tab panel. This one relates to the
                                                    profile tab. You got the finest architecture. Passport stamps, she's
                                                    cosmopolitan. Fine, fresh, fierce, we got it on lock. Never planned
                                                    that one day I'd be losing you. She eats your heart out. Your kiss
                                                    is cosmic, every move is magic. I mean the ones, I mean like she's
                                                    the one. Greetings loved ones let's take a journey. Just own the
                                                    night like the 4th of July! But you'd rather get wasted.</p>
                                            </div>
                                            <div x-show="tabs === 3">
                                                <p>Placeholder content for the tab panel. This one relates to the
                                                    contact tab. Her love is like a drug. All my girls vintage Chanel
                                                    baby. Got a motel and built a fort out of sheets. 'Cause she's the
                                                    muse and the artist. (This is how we do) So you wanna play with
                                                    magic. So just be sure before you give it all to me. I'm walking,
                                                    I'm walking on air (tonight). Skip the talk, heard it all, time to
                                                    walk the walk. Catch her if you can. Stinging like a bee I earned my
                                                    stripes.</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-12">
                                <h2 class="text-lg mb-6 font-semibold text-gray-800 dark:text-gray-300">Vertical tabs
                                </h2>
                            ...
                            <div class="mb-12">
                                <h2 class="text-lg mb-6 font-semibold text-gray-800 dark:text-gray-300">Tabs with
                                    chart.js</h2>
