                    ...
                    <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                        <div class="relative">
                            ...
                            <div class="mb-8">
                                ...
                                <!-- example -->
                                <div
                                    class="bg-gray-100 p-8 border border-gray-200 dark:bg-gray-900 dark:bg-opacity-20 dark:border-gray-800">
                                    <div class="flex flex-wrap flex-row -mx-4">
                                        <div class="flex-shrink max-w-full px-4 w-full lg:w-1/3">
                                            <!-- card -->
                                            <div
                                                class="flex flex-col bg-white dark:bg-gray-800 mb-12 rounded overflow-hidden shadow">
                                                <div class="relative overflow-hidden">
                                                    <a href="card.html#">
                                                        <div
                                                            class="absolute inset-0 hover:bg-white opacity-0 transition duration-700 hover:opacity-10">
                                                        </div>
                                                        <img class="max-w-full h-auto"
                                                            src="../src/img/products/product1.jpg" alt="alt title">
                                                    </a>
                                                </div>
                                                <div class="p-6 flex-1">
                                                    <div class="mb-2">
                                                        <h3
                                                            class="text-lg leading-normal mb-3 font-bold text-gray-800 dark:text-gray-300">
                                                            <a href="card.html#" class="hover:text-indigo-700">New web
                                                                design layout trends in 2021</a></h3>
                                            ...
                                            <div
                                                ...
                                                <div class="relative overflow-hidden">
                                                    <a href="card.html#">
                                                        ...
                                                        <img class="max-w-full h-auto"
                                                            src="../src/img/products/product2.jpg" alt="alt title">
                                                    </a>
                                                </div>
                                                <div class="p-6 flex-1">
                                                    <div class="mb-2">
                                            ...
                                            <div
                                                ...
                                                <div class="relative overflow-hidden">
                                                    <a href="card.html#">
                                                        ...
                                                        <img class="max-w-full h-auto"
                                                            src="../src/img/products/product3.jpg" alt="alt title">
                                                    </a>
                                                </div>
                                                <div class="p-6 flex-1">
                                                    <div class="mb-2">
                            ...
                            <div class="mb-8">
                                ...
                                <div
                                    ...
                                    <!-- card start -->
                                    <div
                                        class="flex flex-col lg:flex-row bg-white dark:bg-gray-800 mb-12 rounded overflow-hidden">
                                        <div class="relative overflow-hidden lg:flex-shrink lg:w-1/3 rounded">
                                            <a href="card.html#">
                                                <div
                                                    class="absolute inset-0 hover:bg-white opacity-0 transition duration-700 hover:opacity-10">
                                                </div>
                                                <img class="max-w-full h-auto" src="../src/img/products/product1.jpg"
                                                    alt="alt title">
                                            </a>
                                        </div>
                                        <div class="p-6 flex-1 lg:flex-shrink lg:w-2/3">
                                            <div class="mb-2">
                                                <h3
                                                    class="text-lg lg:text-2xl leading-normal mb-4 font-semibold text-gray-800 dark:text-gray-300">
                                                    <a href="card.html#" class="hover:text-indigo-700">New web design
                                                        layout trends in 2021</a></h3>
                                                <div class="text-gray-500">
                                                    <svg class="bi bi-calendar ltr:mr-2 rtl:ml-2 inline-block"
                                                        width=".8rem" height=".8rem" viewBox="0 0 16 16"
                                                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
