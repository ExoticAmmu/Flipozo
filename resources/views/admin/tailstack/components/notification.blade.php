                            ...
                            <div class="mb-6">
                                ...
                                <div
                                    ...
                                    <div class="relative inline-block">
                                        ...
                                        <span
                                            class="flex justify-center absolute -top-2 -right-1 text-center bg-red-500 px-1 text-white rounded-full text-xs"><span
                                                class="align-self-center">3</span></span>
                                    </div>

                                    <div class="relative inline-block ltr:ml-8 rtl:mr-8">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            class="w-6 h-6 bi bi-bell" viewBox="0 0 16 16">
                                            <path
