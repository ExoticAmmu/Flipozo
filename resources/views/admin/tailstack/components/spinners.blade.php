                        ...
                        <div class="relative">
                            ...
                            <div class="mb-8">
                                ...
                                <div
                                    ...
                                    <div class="inline-block mr-6">
                                        <svg class="animate-spin h-5 w-5 text-blue-700"
                                    ...
                                    <div class="inline-block mr-6">
                                        <svg class="animate-spin h-5 w-5 text-yellow-300"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                                stroke-width="4"></circle>
                                            <path class="opacity-75" fill="currentColor"
                                    ...
                                    <div class="inline-block mr-6">
                                        <svg class="animate-spin h-5 w-5 text-green-700"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                                stroke-width="4"></circle>
                                            <path class="opacity-75" fill="currentColor"
                                    ...
                                    <div class="inline-block mr-6">
                                        <span class="relative flex h-5 w-5">
                                            ...
                                            <span
                                                class="relative inline-flex rounded-full h-5 w-5 bg-yellow-500"></span>
                                        </span>
                                    </div>
			                ...
			                <code class="language-html" data-lang="html">
			                  ...
			                  &lt;/div&gt;
                                ...
                                <p class="my-4">Add loader-wrapper just below the <code
                                        class="text-pink-700">body</code> tag</p>
                            </div>
                        </div>
                    </div>
                </div>
