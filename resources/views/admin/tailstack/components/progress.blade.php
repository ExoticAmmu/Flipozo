                ...
                <div class="flex flex-wrap flex-row -mx-4">
                  ...
                  <div class="flex-shrink w-1/4 px-4 max-w-full text-center">
                    <div class="flex flex-col flex-nowrap justify-end bg-blue-500 dark:bg-opacity-40 h-48 rounded mb-4">
                      <div class="relative bg-blue-700" style="height:73%"><span class="w-full text-white pt-2 absolute left=0 right-0 py-1 font-bold">73%</span>
                      </div>
                    </div>
                  ...
                  <div class="flex-shrink w-1/4 px-4 max-w-full text-center">
                    <div class="flex flex-col flex-nowrap justify-end bg-red-500 dark:bg-opacity-40 h-48 rounded mb-4">
                      <div class="relative bg-red-700" style="height:53%"><span class="w-full text-white pt-2 absolute left=0 right-0 py-1 font-bold">53%</span>
                      </div>
                    </div>
                  ...
                  <div class="flex-shrink w-1/4 px-4 max-w-full text-center">
                    <div class="flex flex-col flex-nowrap justify-end bg-yellow-500 dark:bg-opacity-40 h-48 rounded mb-4">
                      <div class="relative bg-yellow-300" style="height:83%"><span class="w-full text-gray-800 pt-2 absolute left=0 right-0 py-1 font-bold">83%</span>
                      </div>
                    </div>
                  ...
                  <div class="flex-shrink w-1/4 px-4 max-w-full text-center">
                    <div class="flex flex-col flex-nowrap justify-end bg-green-500 dark:bg-opacity-40 h-48 rounded mb-4">
                      <div class="relative bg-green-700" style="height:93%"><span class="w-full text-white pt-2 absolute left=0 right-0 py-1 font-bold">93%</span>
                      </div>
                    </div>
