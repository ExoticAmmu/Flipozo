                                ...
                                <div class="mb-6">
                                    ...
                                    <div
                                        ...
                                        <div x-data="{ open: true }" x-show="open"
                                            class="flex justify-between items-center relative bg-gray-200 text-blue-900 py-3 px-6 rounded mb-4">
                                            <div>
                                        ...
                                        <div x-data="{ open: true }" x-show="open"
                                            class="flex justify-between items-center relative bg-yellow-100 text-yellow-900 py-3 px-6 rounded mb-4">
                                            <div>
                                        ...
                                        <div x-data="{ open: true }" x-show="open"
                                            class="flex justify-between items-center relative bg-green-100 text-green-900 py-3 px-6 rounded mb-4">
                                            <div>
                                        ...
                                        <div x-data="{ open: true }" x-show="open"
                                            class="flex justify-between items-center relative bg-blue-200 text-gray-900 py-3 px-6 rounded mb-4">
                                            <div>
                                        ...
                                        <div x-data="{ open: true }" x-show="open"
                                            class="flex justify-between items-center relative bg-gray-50 text-gray-900 py-3 px-6 rounded mb-4">
                                            <div>
                                        ...
                                        <div x-data="{ open: true }" x-show="open"
                                            class="flex justify-between items-center relative bg-gray-500 text-gray-100 py-3 px-6 rounded mb-4">
                                            <div>
