                    ...
                    <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                        <div class="relative">
                            ...
                            <div class="mb-6">
                                ...
                                <!-- example -->
                                <div
                                    class="bg-white p-8 pb-12 border border-gray-200 dark:bg-gray-900 dark:bg-opacity-20 dark:border-gray-800">
                                    <!-- Popovers top -->
                                    <div x-data="{ open: false }" class="relative inline-block mb-3">
                                        ...
                                        <!-- Popovers area -->
                                        <div class="absolute top-auto bottom-full mb-3" x-show="open"
                                            @click.away="open = false">
                                            <div
                                                class="z-40 w-32 p-3 -mb-1 text-sm leading-tight text-gray-700 bg-white border border-gray-200 rounded-lg shadow-lg text-center">
                                                Popovers on top
                                            </div>
                                            <div
                                                class="absolute transform -rotate-45 p-1 w-1 bg-white border-l border-b border-gray-200 bottom-0 -mb-2 ltr:ml-6 rtl:mr-6">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div x-data="{ open: false }" class="relative inline-block mb-3">
                                        ...
                                        <!-- Popovers area -->
                                        <div class="absolute top-full bottom-auto mt-3" x-show="open"
                                            @click.away="open = false">
                                            <div
                                                class="z-40 w-32 p-3 -mt-1 text-sm leading-tight text-gray-700 bg-white rounded-lg border border-gray-200 shadow-lg text-center">
                                                Popovers on bottom
                                            </div>
                                            <div
                                                class="absolute transform -rotate-45 p-1 w-1 bg-white border-r border-t border-gray-200 top-0 -mt-2 ltr:ml-6 rtl:mr-6">
                                            </div>
                                        </div>
                                    </div>
                                </div>
