                        ...
                        <div class="relative">
                                    ...
                                    <div class="flex justify-center">
                                        <div x-data="{ open: false }">
                                            ...
                                            <button id="navbartoggle" type="button"
                                                class="inline-flex items-center justify-center text-gray-800 hover:text-gray-700 dark:text-gray-400 dark:text-gray-300 focus:outline-none focus:ring-0"
                                            ...
                                            <!-- Right Offcanvas -->
                                            <div class="fixed w-full h-full inset-0 z-50" id="mobile-menu"
                                                ...
                                                <!-- Mobile navbar -->
                                                <nav id="mobile-nav"
                                                    class="flex flex-col right-0 w-64 fixed top-0 py-4 bg-white dark:bg-gray-800 h-full overflow-auto z-40"
                                                        ...
                                                        <div class="mh-18 text-center px-12 mb-8">
                                                            <a href="offcanvas.html#" class="flex relative">
                                                                <h2
                                                                    ...
                                                                    <img class="inline-block w-7 h-auto mr-2 -mt-1"
                                                                ...
                                                                <ul id="side-menu"
                                                                    ...
                                                                    <li class="relative">
                                                                        <a href="offcanvas.html#"
                                                                            class="block py-3 px-4 hover:text-blue-700 focus:text-blue-700">Home</a>
                                                                    </li>
                                                                    <li class="relative">
                                                                        <a href="offcanvas.html#"
                                                                            class="block py-3 px-4 hover:text-blue-700 focus:text-blue-700">About</a>
                                                                    </li>

                                                                    <li class="relative">
                                                                        <a href="offcanvas.html#"
                                                                            class="block py-3 px-4 hover:text-blue-700 focus:text-blue-700">Support</a>
                                                                    </li>
                                                                </ul>
                                                            </nav>
                                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="flex justify-center">
                                        <div x-data="{ open: false }">
                                            ...
                                            <button id="navbartoggle" type="button"
                                                class="inline-flex items-center justify-center text-gray-800 hover:text-gray-700 dark:text-gray-400 dark:text-gray-300 focus:outline-none focus:ring-0"
                                                aria-controls="mobile-menus" @click="open = !open" aria-expanded="false"
                                                x-bind:aria-expanded="open.toString()">
                                                <span class="sr-only">Mobile menu</span>
                                                <svg x-description="Icon closed" x-state:on="Menu open"
                                                    x-state:off="Menu closed" class="block h-8 w-8"
                                            ...
                                            <!-- Offcanvas -->
                                            <div class="fixed w-full h-full inset-0 z-50" id="mobile-menus"
                                                x-description="Mobile menu" x-show="open" style="display: none;">
                                                <!-- bg open -->
                                                <span
                                                    class="fixed bg-gray-900 bg-opacity-70 w-full h-full inset-x-0 top-0"></span>
			                ...
			                <code class="language-html" data-lang="html">
			                  ...
			                  &lt;/div&gt;
                                ...
                                <p class="my-4">Offcanvas is ready in default navbar <a
                                        href="navbar.html#navbar-offcanvas" class="text-blue-500">Navbar Offcanvas
                                        mobile</a></p>
                            </div>
                        </div>
                    </div>
