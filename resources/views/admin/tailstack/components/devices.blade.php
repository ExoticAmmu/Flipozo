                        ...
                        <div class="relative">
                                        ...
                                        <div class="flex-shrink max-w-full px-4 w-full md:w-1/3">
                                            ...
                                            <figure class="relative">
                                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Phone screen -->
                                                    <image clip-path="url(#svgf)"
                                                        xlink:href="../src/img/app/android-potrait.jpg" height="94%"
                                                        width="100%" style="transform:translateY(15px);"></image>
                                                    <!-- Phone cover -->
                                                    <image xlink:href="../src/img/app/device/android-dark.png"
                                        ...
                                        <div class="flex-shrink max-w-full px-4 w-full md:w-1/3">
                                            ...
                                            <figure class="relative">
                                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Phone screen -->
                                                    <image clip-path="url(#svgf2)"
                                                        xlink:href="../src/img/app/iphone-potrait.jpg" height="92%"
                                                        width="100%" style="transform:translateY(30px);"></image>
                                                    <!-- Phone cover -->
                                                    <image xlink:href="../src/img/app/device/iphone-dark.png"
                                                        height="100%" width="100%"></image>
                                                </svg>
                                            </figure>
                                        </div>
                                        <div class="flex-shrink max-w-full px-4 w-full md:w-1/3">
                                            ...
                                            <figure class="relative">
                                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Phone screen -->
                                                    <image clip-path="url(#svgf3)"
                                                        xlink:href="../src/img/app/iphone-potrait.jpg" height="92%"
                                                        width="100%" style="transform:translateY(30px);"></image>
                                                    <!-- Phone cover -->
                                                    <image xlink:href="../src/img/app/device/iphone-light.png"
                                                        height="100%" width="100%"></image>
                                                </svg>
                                            </figure>
                                        </div>
			                ...
			                <code class="language-html" data-lang="html">
			                  ...
			                  &lt;/figure&gt;
                                ...
                                <p class="mb-4">Very simple to change screenshot, just edit <code
                                        class="text-pink-700">Phone screen</code> source images. If you use more than 1
                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap flex-row -mx-4">
                                        <div class="flex-shrink max-w-full px-4 w-full md:w-1/3">
                                            ...
                                            <figure class="relative">
                                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 906.000000 480.000000">
                                                    <!-- Clip path image -->
                                                    <defs>
                                                        <clipPath id="svgf4">
                                                    ...
                                                    <!-- Phone screen -->
                                                    <image clip-path="url(#svgf4)"
                                                        xlink:href="../src/img/app/android-landscape.jpg" height="100%"
                                                        width="95%" style="transform:translateX(15px);"></image>
                                                    <!-- Phone cover -->
                                                    <image xlink:href="../src/img/app/device/android-dark-landscape.png"
                                                        height="100%" width="100%"></image>
                                                </svg>
                                            </figure>
                                        </div>
                                        <div class="flex-shrink max-w-full px-4 w-full md:w-1/3">
                                            ...
                                            <figure class="relative">
                                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Phone screen -->
                                                    <image clip-path="url(#svgf5)"
                                                        xlink:href="../src/img/app/iphone-landscape.jpg" width="96%"
                                                        height="100%" style="transform:translateX(30px);"></image>
                                                    <!-- Phone cover -->
                                                    <image xlink:href="../src/img/app/device/iphone-dark-landscape.png"
                                                        height="100%" width="100%"></image>
                                                </svg>
                                            </figure>
                                        </div>
                                        <div class="flex-shrink max-w-full px-4 w-full md:w-1/3">
                                            ...
                                            <figure class="relative">
                                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Phone screen -->
                                                    <image clip-path="url(#svgf6)"
                                                        xlink:href="../src/img/app/iphone-landscape.jpg" width="96%"
                                                        height="100%" style="transform:translateX(30px);"></image>
                                                    <!-- Phone cover -->
                                                    <image xlink:href="../src/img/app/device/iphone-light-landscape.png"
                                                        height="100%" width="100%"></image>
                                                </svg>
                                            </figure>
                                        </div>
                                        ...
                                        <div class="flex-shrink max-w-full px-4 w-full md:w-2/3">
                                            ...
                                            <figure class="relative">
                                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Phone screen -->
                                                    <image clip-path="url(#svgf77)"
                                                        xlink:href="../src/img/app/macbook-screen2.jpg" height="80%"
                                                        width="80%" style="transform:translate(96px, 40px);"></image>
                                                    <!-- Phone cover -->
                                                    <image xlink:href="../src/img/app/device/macbook.png" height="100%"
                                                        width="100%"></image>
                                                </svg>
                                            </figure>
                                        </div>
                                            ...
                                            <div class="relative" style="padding-bottom:66%">
                                                ...
                                                <figure class="absolute top-0 right-0 w-full">
                                                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <image clip-path="url(#svgf77)"
                                                            xlink:href="../src/img/app/macbook-screen2.jpg" height="80%"
                                                            width="80%" style="transform:translate(96px, 40px);">
                                                        </image>
                                                        <!-- Phone cover -->
                                                        <image xlink:href="../src/img/app/device/macbook.png"
                                                            height="100%" width="100%"></image>
                                                    </svg>
                                                </figure>
                                                ...
                                                <figure class="absolute left-0 bottom-1 w-1/4">
                                                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <!-- Phone screen -->
                                                        <image clip-path="url(#svgf2)"
                                                            xlink:href="../src/img/app/iphone-potrait2.jpg" height="92%"
                                                            width="100%" style="transform:translateY(30px);"></image>
                                                        <!-- Phone cover -->
                                                        <image xlink:href="../src/img/app/device/iphone-dark.png"
                                                            height="100%" width="100%"></image>
