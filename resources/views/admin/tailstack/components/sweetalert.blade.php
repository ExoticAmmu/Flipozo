                ...
                <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                    <div class="relative">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-green-500 border border-green-500 hover:text-white hover:bg-green-600 hover:ring-0 hover:border-green-600 focus:bg-green-600 focus:border-green-600 focus:outline-none focus:ring-0"
                                    aria-label="Show SweetAlert2 success message" onclick="SuccessAlert()">Show success
                                    message</button>
                            </div>
                            <pre>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    ...
                                    aria-label="Show SweetAlert2" onclick="ErrorAlert()">Try me!</button>
                            </div>
                            <pre>
                    <code class="language-html" data-lang="html">
Swal.fire({
  ...
  footer: '&lt;a href="#"&gt;Why do I have this issue?&lt;/a&gt;'
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                                    aria-label="Show SweetAlert2" onclick="HtmlAlert()">Try me!</button>
                            </div>
                            <pre>
                    <code class="language-html" data-lang="html">
Swal.fire({
  ...
  cancelButtonAriaLabel: 'Thumbs down'
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                                    aria-label="Show SweetAlert2" onclick="ThreeAlert()">Try me!</button>
                            </div>
                            <pre>
                    <code class="language-html" data-lang="html">
Swal.fire({
    ...
    Swal.fire('Changes are not saved', '', 'info')
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                                    aria-label="Show SweetAlert2" onclick="ImageAlert()">Try me!</button>
                            </div>
                            <pre>
                    <code class="language-html" data-lang="html">
Swal.fire({
  ...
  imageAlt: 'Custom image',
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                                    aria-label="Show SweetAlert2" onclick="AutoAlert()">Try me!</button>
                            </div>
                            <pre>
                    <code class="language-html" data-lang="html">
let timerInterval
    ...
    console.log('I was closed by the timer')
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                                    aria-label="Show SweetAlert2" onclick="RtlAlert()">Try me!</button>
                            </div>
                            <pre>
                    <code class="language-html" data-lang="html">
Swal.fire({
  ...
  showCloseButton: true
                        ...
                        <div class="mb-6">
                            ...
                            <div class="pb-4">
                                <button
                                    class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                                    aria-label="Show SweetAlert2" onclick="AjaxAlert()">Try me!</button>
                            </div>
                            <pre>
                    <code class="language-html" data-lang="html">
Swal.fire({
  ...
  if (result.isConfirmed) {
    Swal.fire({
      ...
      imageUrl: result.value.avatar_url
                        ...
                        <div class="mb-6">
                            <p>You can see complete demo and documentation on here <a target="_blank"
                                    class="text-indigo-500"
                                    href="https://sweetalert2.github.io/">https://sweetalert2.github.io/</a></p>
                        </div>
                    </div>
                </div>
            </div>
