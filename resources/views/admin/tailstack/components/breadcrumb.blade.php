            ...
            <div class="flex flex-wrap flex-row">
                ...
                <div class="flex-shrink max-w-full px-4 w-full mb-6">
                    <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                        <div class="relative">
                            <div class="mb-6">
                                <p class="leading-relaxed font-light text-lg mx-auto pb-2">Indicate the current page’s
                                    location within a navigational hierarchy that automatically adds separators.</p>
                            </div>

                            <div class="mb-8">
                                <h2 class="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">Example</h2>
                                <p class="mb-4">Use an ordered or unordered list with linked list items to create a
                                    minimally styled breadcrumb.</p>
                                <!-- example -->
                                <div
                                            ...
                                            <li>
                                                <a href="breadcrumb.html#" class="hover:text-indigo-500">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="mx-1 transform ltr:rotate-0 rtl:rotate-180 inline-block"
                                    ...
                                    <nav aria-label="breadcrumb" class="mb-4">
                                        <ol class="flex flex-wrap justify-start bg-transparent text-sm mb-0 space-x-1">
                                            ...
                                            <li class="hidden md:block text-indigo-500" aria-current="page">Business
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                            ...
                            <div class="mb-8">
                                <h2 class="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">Dark Breadcrumb
                                </h2>
                                <!-- example -->
			                ...
			                <code class="language-html" data-lang="html">
			                  ...
			                  &lt;/nav&gt;
                                ...
                                <p class="my-4">Edit breadcrumb from left to center replace <code
                                        class="text-pink-700">justify-start</code> with <code
                                        class="text-pink-700">justify-center</code></p>
                            </div>
                        </div>
                    </div>
                </div>
