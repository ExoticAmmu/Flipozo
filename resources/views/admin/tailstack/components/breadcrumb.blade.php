                  ...
                  <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="flex flex-wrap justify-start bg-transparent text-sm mb-0 space-x-1">
                      <li>
                        <a href="breadcrumb.html#" class="hover:text-indigo-500">
                          Home
                          <svg xmlns="http://www.w3.org/2000/svg" class="mx-1 transform ltr:rotate-0 rtl:rotate-180 inline-block" width="1rem" height="1rem" fill="currentColor" viewBox="0 0 512 512">
