                                ...
                                <div
                                    ...
                                    <div x-data="{ tooltips: false }" class="relative inline-block mb-3">
                                        ...
                                        <div class="absolute top-auto bottom-full mb-3" x-cloak
                                            ...
                                            <div
                                                class="z-40 w-32 p-3 -mb-1 text-sm leading-tight text-white bg-black rounded-lg shadow-lg text-center">
                                                Tooltip on top
                                            </div>
                                            <div
                                    ...
                                    <div x-data="{ tooltips: false }" class="relative inline-block mb-3">
                                        ...
                                        <!-- tooltip area -->
                                        <div class="absolute top-full bottom-auto mt-3" x-cloak
                                            x-show.transition.origin.top="tooltips">
                                            <div
                                                class="z-40 w-32 p-3 -mt-1 text-sm leading-tight text-white bg-black rounded-lg shadow-lg text-center">
                                                Tooltip on bottom
                                            </div>
                                            <div
                                                class="absolute transform -rotate-45 p-1 w-1 bg-black top-0 -mt-2 ltr:ml-6 rtl:mr-6">
                                            </div>
                                        </div>
                                    </div>
                                </div>
