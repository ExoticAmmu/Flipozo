...
<body class="font-sans text-base font-normal text-gray-600 dark:text-gray-400 dark:bg-gray-800 pt-18">
  <!-- preloader -->
        ...
        <div class="flex flex-wrap flex-row -mx-4 justify-center">
          ...
          <div class="flex-shrink max-w-full px-4 w-full md:w-9/12 lg:w-1/2 self-center lg:ltr:pr-12 lg:rtl:pl-12">
            <div class="text-center lg:ltr:text-left lg:rtl:text-right mt-6 lg:mt-0">
              <div class="mb-8">
                <h1 class="text-white text-4xl leading-normal mb-3 font-bold">Taildash is Tailwind Css dashboard template</h1>
                <p class="text-gray-400 leading-relaxed font-light text-xl mx-auto pb-2">Tailwind dashboard come with popular tools like npm, gulp and browsersync. Very simple and easy to use.</p>
              </div>
    ...
    <div id="features" class="relative pt-14 pb-2 md:pt-16 md:pb-4 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
      <div class="container xl:max-w-6xl mx-auto px-4">
        ...
        <header class="text-center mx-auto mb-12">
          ...
          <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">Clean and well commented code allows easy customization of the theme even for beginners.</p>
        ...
        <div class="flex flex-wrap flex-row -mx-4 text-center">
          ...
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6">
            ...
            <div class="p-6 mb-12 shadow-lg rounded-lg bg-white dark:bg-gray-800 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              ...
              <h3 class="text-lg leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-300">Responsive Design</h3>
          ...
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6">
            ...
            <div class="p-6 mb-12 shadow-lg rounded-lg bg-white dark:bg-gray-800 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              ...
              <h3 class="text-lg leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-300">Modern Tools</h3>
          ...
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6">
            ...
            <div class="p-6 mb-12 shadow-lg rounded-lg bg-white dark:bg-gray-800 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              ...
              <h3 class="text-lg leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-300">Clean Code</h3>
          ...
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6">
            ...
            <div class="p-6 mb-12 shadow-lg rounded-lg bg-white dark:bg-gray-800 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              ...
              <h3 class="text-lg leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-300">Svg and Font Icons</h3>
        ...
        <div class="flex flex-wrap flex-row -mx-4">
          <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 relative">
            <div class="pb-8 px-3 text-center">
              <img class="mx-auto max-w-full h-auto" src="src/img/svg/website.svg" alt="company profile">
            </div>
          </div>
          <div class="flex-shrink max-w-full px-4 w-full md:w-1/2">
            <div class="pb-8 px-3">
              <p class="leading-relaxed font-light text-xl mx-auto pb-2 mb-3">Tailwind admin template with flat design and fast loading. This template is perfect for make awesome dasboard admin for your site.</p>
              <p class="leading-relaxed font-light text-xl mx-auto pb-2 mb-12">Comes with a variety of ready-to-use pages that help to speed up the development.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="demo" class="relative pt-14 pb-4 md:pt-16 md:pb-6 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
      <div class="container xl:max-w-6xl mx-auto px-4">
        ...
        <header class="text-center mx-auto mb-12">
          ...
          <hr class="block w-12 h-0.5 mx-auto my-5 bg-indigo-500 border-indigo-500">
          <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">There are three layout options that you can use.</p>
        </header><!-- end section header -->
            ...
            <div x-data="{ tabs: 3 }" class="px-2 text-center">
              ...
              <div x-show="tabs === 1" class="relative">
                <a target="_blank" href="index.html">
                  <img src="src/img/demo/light.jpg" class="max-w-full mx-auto shadow-lg transform transition duration-300 ease-in-out hover:-translate-y-1 border border-gray-200 dark:border-gray-700" alt="Demo dashboard">
                </a>
              </div>
              <div x-show="tabs === 2" class="relative">
                <a target="_blank" href="layout-dark.html">
                  <img src="src/img/demo/dark.jpg" class="max-w-full mx-auto shadow-lg transform transition duration-300 ease-in-out hover:-translate-y-1 border border-gray-200 dark:border-gray-700" alt="Demo dashboard">
                </a>
              </div>
              <div x-show="tabs === 3" class="relative">
                <a target="_blank" href="layout-sidedark.html">
                  <img src="src/img/demo/sidedark.jpg" class="max-w-full mx-auto shadow-lg transform transition duration-300 ease-in-out hover:-translate-y-1 border border-gray-200 dark:border-gray-700" alt="Demo dashboard">
                </a>
              </div>
            </div>
          </div>
            ...
            <div x-data="{ tabs: 1 }" class="px-2 text-center">
              ...
              <div x-show="tabs === 1" class="relative">
                <a target="_blank" href="layout-compact.html">
                  <img src="src/img/demo/compact.jpg" class="max-w-full mx-auto shadow-lg transform transition duration-300 ease-in-out hover:-translate-y-1 border border-gray-200 dark:border-gray-700" alt="Demo dashboard">
                </a>
              </div>
              <div x-show="tabs === 2" class="relative">
                <a target="_blank" href="layout-topnav.html">
                  <img src="src/img/demo/top-navbar.jpg" class="max-w-full mx-auto shadow-lg transform transition duration-300 ease-in-out hover:-translate-y-1 border border-gray-200 dark:border-gray-700" alt="Demo dashboard">
                </a>
              </div>
              <div x-show="tabs === 3" class="relative">
                <a target="_blank" href="layout-rtl.html">
                  <img src="src/img/demo/rtl.jpg" class="max-w-full mx-auto shadow-lg transform transition duration-300 ease-in-out hover:-translate-y-1 border border-gray-200 dark:border-gray-700" alt="Demo dashboard">
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="flex-shrink max-w-full w-full sm:w-11/12 md:w-1/2 lg:w-1/3 px-4">
              <div class="px-6 md:px-2 lg:px-4">
                ...
                <div class="relative py-16 px-12 mb-12 lg:-mt-6 bg-white dark:bg-gray-900 dark:bg-opacity-40 transform transition duration-300 ease-in-out hover:-translate-y-1 shadow-lg text-center rounded-lg">
                  ...
                  <!-- Pricing Button -->
                  <div class="py-2">
                   <a href="landing.html#" rel="noopener" class="py-2 px-4 -ml-1 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">Buy Now</a>
                  </div>
            ...
            <div class="nav-dark-button" data-flickity='{ "cellAlign": "left", "wrapAround": true, "adaptiveHeight": true, "pageDots": false, "imagesLoaded": true }'>
              <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-4 lg:py-1 px-6 lg:px-12 text-center">
                <a href="landing.html#" target="_blank">
                  <img class="brands-image mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="src/img/brand/img1.png" alt="Image Description">
                </a>
              </div>
              <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-4 lg:py-1 px-6 lg:px-12 text-center">
                <a href="landing.html#" target="_blank">
                  <img class="brands-image mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="src/img/brand/img2.png" alt="Image Description">
                </a>
              </div>
              <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-4 lg:py-1 px-6 lg:px-12 text-center">
                <a href="landing.html#" target="_blank">
                  <img class="brands-image mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="src/img/brand/img3.png" alt="Image Description">
                </a>
              </div>
              <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-4 lg:py-1 px-6 lg:px-12 text-center">
                <a href="landing.html#" target="_blank">
                  <img class="brands-image mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="src/img/brand/img4.png" alt="Image Description">
                </a>
              </div>
              <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-4 lg:py-1 px-6 lg:px-12 text-center">
                <a href="landing.html#" target="_blank">
                  <img class="brands-image mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="src/img/brand/img5.png" alt="Image Description">
                </a>
              </div>
              <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-4 lg:py-1 px-6 lg:px-12 text-center">
                <a href="landing.html#" target="_blank">
                  <img class="brands-image mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="src/img/brand/img6.png" alt="Image Description">
                </a>
              </div>
  ...
  <!-- =========={ FOOTER }==========  -->
  <footer class="bg-gray-800 text-gray-400 dark:bg-gray-900">
      ...
      <div class="flex flex-wrap flex-row -mx-4">
        ...
        <div class="flex-shrink max-w-full w-full lg:w-1/3 px-4 mb-7 lg:mb-0">
          ...
          <div class="leading-relaxed">
            ...
            <p class="mb-3">Tailnet is template designer, we build web templates, themes and other goodies, putting a lot of love in every pixel and design.</p>
            <address class="mb-3">
          ...
          <div class="leading-relaxed">
            ...
            <div class="flex flex-wrap flex-row -mx-4">
              <div class="flex-shrink max-w-full w-1/2 px-4">
                <ul class="space-y-2">
                  <li><a class="hover:text-gray-300" href="landing.html#">About us</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Contact us</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Privacy policy</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Term of use</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">GDPR</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Career</a></li>
                </ul>
              </div>
              <div class="flex-shrink max-w-full w-1/2 px-4">
                <ul class="space-y-2">
                  <li><a class="hover:text-gray-300" href="landing.html#">Latest post</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Popular post</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Blogs</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Events</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Fax</a></li>
                  <li><a class="hover:text-gray-300" href="landing.html#">Category</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="flex-shrink max-w-full w-full lg:w-1/3 px-4 mb-7 lg:mb-0">
          ...
          <div class="leading-relaxed">
            ...
            <div class="mx-auto mb-7">
              <form id="subscribe" class="relative" action="landing.html#">
                <!-- input group -->
            ...
            <ul class="space-x-3">
              ...
              <li class="inline-block">
                <a target="_blank" class="hover:text-gray-300" rel="noopener noreferrer" href="https://facebook.com" title="Facebook">
              ...
              <!--twitter-->
              <li class="inline-block">
                <a target="_blank" class="hover:text-gray-300" rel="noopener noreferrer" href="https://twitter.com" title="Twitter">
              ...
              <!--youtube-->
              <li class="inline-block">
                <a target="_blank" class="hover:text-gray-300" rel="noopener noreferrer" href="https://youtube.com" title="Youtube">
              ...
              <!--VKontakte-->
              <li class="inline-block">
                <a target="_blank" class="hover:text-gray-300" rel="noopener noreferrer" href="https://vk.com" title="VKontakte">
              ...
              <!--Linkedin-->
              <li class="inline-block">
                <a target="_blank" class="hover:text-gray-300" rel="noopener noreferrer" href="https://linkedin.com" title="Linkedin">
              ...
              <!--instagram-->
              <li class="inline-block">
                <a target="_blank" class="hover:text-gray-300" rel="noopener noreferrer" href="https://instagram.com" title="Instagram">
