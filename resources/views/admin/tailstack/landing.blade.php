<x-admin-layout>
    ...
    <main id="content">
        <!-- =========={ Hero }==========  -->
        <div id="hero"
            class="relative z-0 pt-32 lg:pt-36 pb-20 text-gray-300 bg-indigo-600 bg-gradient-to-r from-indigo-800 via-indigo-700 to-green-500 dark:from-gray-800 dark:via-gray-700 dark:to-green-700 overflow-hidden">
                ...
                <div class="flex flex-wrap flex-row -mx-4 justify-center">
                    ...
                    <div
                        ...
                        <div class="text-center lg:ltr:text-left lg:rtl:text-right mt-6 lg:mt-0">
                            ...
                            <a class="py-2 px-4 inline-block text-center rounded leading-5 text-gray-700 bg-gray-300 border border-gray-300  hover:bg-gray-200 hover:ring-0 hover:border-gray-200 focus:bg-gray-200 focus:border-gray-200 focus:outline-none focus:ring-0 mr-4"
                                href="landing.html#features">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="inline-block ltr:mr-2 rtl:ml-2 bi bi-check2-circle" viewBox="0 0 16 16">
                                    <path
            ...
            <div class="container xl:max-w-6xl mx-auto px-4">
                ...
                <div class="flex flex-wrap flex-row -mx-4 text-center">
                    <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6">
                        <!-- service block -->
                        <div
                            class="p-6 mb-12 shadow-lg rounded-lg bg-white dark:bg-gray-800 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
                    ...
                    <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6">
                        ...
                        <div
                            ...
                            <div class="inline-block text-indigo-500 mb-4">
                                <!-- icon -->
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 h-8 bi bi-tablet"
                                    viewBox="0 0 16 16">
                                    <path
                    ...
                    <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6">
                        ...
                        <div
                            ...
                            <div class="inline-block text-indigo-500 mb-4">
                                <!-- icon -->
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 h-8 bi bi-braces"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        <div x-data="{ tabs: 3 }" class="px-2 text-center">
                            ...
                            <div class="flex inline-flex mb-4" role="group">
                                <button @click="tabs = 1" :class="{ 'bg-indigo-600': tabs === 1 }" type="button"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="inline-block ltr:mr-2 rtl:ml-2 bi bi-sun" viewBox="0 0 16 16">
                                        <path
                                ...
                                <button @click="tabs = 2" :class="{ 'bg-indigo-600': tabs === 2 }" type="button"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="inline-block ltr:mr-2 rtl:ml-2 bi bi-moon" viewBox="0 0 16 16">
                                        <path
