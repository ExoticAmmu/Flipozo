                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg mb-8">
                        ...
                        <div class="flex justify-center -mt-10 relative">
                            <a @click="open = true" class="z-30 group" href="javascript:;">
                                <img src="src/img/avatar/avatar.png"
                                    ...
                                    <div class="relative">
                                        <a @click="open = true" href="javascript:;" title="edit information"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="w-4 h-4 bi bi-pencil-square"
                                                viewBox="0 0 16 16">
                                                <path
                                    ...
                                    <div x-data="{ open: false }" class="relative">
                                        ...
                                        <div x-show="open" @click.away="open = false"
                                            ...
                                            <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 dark:hover:bg-opacity-20 dark:focus:bg-gray-900"
                                                href="pages-profile.html#">Daily</a>
                                            <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 dark:hover:bg-opacity-20 dark:focus:bg-gray-900"
                                                href="pages-profile.html#">Weekly</a>
                                            <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 dark:hover:bg-opacity-20 dark:focus:bg-gray-900"
                                                href="pages-profile.html#">Yearly</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col mb-3">
                                    <h3 class="mb-1">Welcome, <span
                                            class="font-bold text-gray-800 dark:text-gray-300">Ari Budin</span></h3>
                                    <p class="text-base">You have <span class="font-semibold text-red-500">3 task</span>
                                        to finish all task today. Your already completed <span
                                            class="font-semibold text-green-500">76%</span> task. Your perform is <span
                                            class="font-semibold text-green-500">Very good</span>.</p>
                                </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                                ...
                                <ul>
                                    <li>
                                        <a href="pages-profile.html#" class="flex my-6">
                                            <div class="block relative">
                                                <img alt="profil" src="src/img/avatar/avatar6.png"
                                                    class="mx-auto object-cover rounded-full h-10 w-10 ">
                                            </div>
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm text-gray-900 font-semibold dark:text-white ltr:ml-2 rtl:mr-2 mb-1">Carlos
                                                    Garcia</span>
                                                <span
                                                    class="text-sm text-gray-400 dark:text-gray-300 ltr:ml-2 rtl:mr-2">What
                                    ...
                                    <li>
                                        <a href="pages-profile.html#" class="flex my-6">
                                            <div class="block relative">
                                                <img alt="profil" src="src/img/avatar/avatar3.png"
                                                    class="mx-auto object-cover rounded-full h-10 w-10 ">
                                            </div>
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm text-gray-900 font-semibold dark:text-white ltr:ml-2 rtl:mr-2 mb-1">Roman
                                                    davis</span>
                                                <span
                                                    class="text-sm text-gray-400 dark:text-gray-300 ltr:ml-2 rtl:mr-2">What
                                                    do you think about this project?</span>
                                    ...
                                    <li>
                                        <a href="pages-profile.html#" class="flex my-6">
                                            <div class="block relative">
                                                <img alt="profil" src="src/img/avatar/avatar7.png"
                                                    class="mx-auto object-cover rounded-full h-10 w-10 ">
                                            </div>
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm text-gray-900 font-semibold dark:text-white ltr:ml-2 rtl:mr-2 mb-1">Jessica
                                                    jane</span>
                                                <span
                                                    class="text-sm text-gray-400 dark:text-gray-300 ltr:ml-2 rtl:mr-2">What
                                                    do you think about this project?</span>
                        ...
                        <div class="flex-shrink max-w-full px-4 w-full lg:w-2/3 mb-8">
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
                                ...
                                <div class="flex justify-between mt-3">
                                    ...
                                    <div>
                                        <span
                                            class="px-2 py-1 text-xs rounded font-semibold text-green-500 bg-green-50">Front
                                            End</span>
                                        <span
                                            class="px-2 py-1 text-xs rounded text-blue-500 font-semibold bg-blue-100">UI/UX</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
                                ...
                                <div class="flex items-center justify-between my-3">
                                    <span
                                        class="px-2 py-1 flex items-center font-semibold text-xs rounded text-gray-500 bg-gray-200">Complete</span>
                                    <span
                                        class="px-2 py-1 flex items-center font-semibold text-xs rounded text-gray-500 bg-gray-200">Due
                                        date: 1-08-2022</span>
                                </div>
                                <div class="relative mb-4">
                                    <a href="pages-profile.html#">
