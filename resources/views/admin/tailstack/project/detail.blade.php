                ...
                <div class="flex-shrink max-w-full px-4 w-full lg:w-1/2 mb-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 h-full">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 dark:hover:bg-opacity-20 dark:focus:bg-gray-900"
                                        href="detail.html#">Update</a>
                                    <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 dark:hover:bg-opacity-20 dark:focus:bg-gray-900"
                                        href="detail.html#">Delete</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <span
                                class="px-2 py-1 flex items-center font-semibold text-xs rounded text-yellow-700 bg-yellow-200">On
                                Progress</span>
                            <span
                                class="px-2 py-1 flex items-center font-semibold text-xs rounded text-red-400 border border-red-400  bg-white">Due
                                date: 15-11-2022</span>
                        </div>

                        <div class="relative mb-4">
                            <a href="detail.html#">
                                <img class="inline-block rounded-full shadow-xl w-12 h-12 max-w-full ltr:-mr-4 rtl:-ml-4 border-2 bg-gray-300 border-gray-200 transform hover:-translate-y-1"
                        ...
                        <div class="flex justify-between mt-3">
                            <div>
                                <span class="text-sm inline-block text-gray-500 dark:text-gray-100">Task done : <span
                            ...
                            <div>
                                <span class="px-2 py-1 text-xs rounded font-semibold text-green-500 bg-green-50">Front
                                    End</span>
                                <span
                                    class="px-2 py-1 text-xs rounded text-indigo-500 font-semibold bg-indigo-100">UI/UX</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="relative">
                            <div class="flex">
                                <ul class="p-2 mt-2 space-y-2 w-full">
                                    <li class="flex">
                                        <div
                                            class="inline-flex items-center w-full py-1 px-3 text-sm font-semibold rounded">
                                            <span
                                                class="self-center w-14 h-14 rounded-full bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20 relative text-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor"
                                                    class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 w-8 h-8 text-indigo-500 bi bi-cash"
                                                    viewBox="0 0 16 16">
                                            ...
                                            <div
                                                class="ltr:ml-6 ltr:pl-2 rtl:mr-6 rtl:pr-2 pt-1 text-base ltr:text-left rtl:text-right">
                                            ...
                                            <div
                                                class="ltr:ml-auto ltr:pl-2 pt-1 text-base ltr:text-right rtl:mr-auto rtl:pr-2 rtl:text-left">
                                    ...
                                    <li class="flex">
                                        <div
                                            ...
                                            <span
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor"
                                                    class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 w-8 h-8 text-indigo-500 bi bi-list-task"
                                                    viewBox="0 0 16 16">
                                    ...
                                    <li class="flex">
                                        <div
                                            ...
                                            <span
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor"
                                                    class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 w-8 h-8 text-indigo-500 bi bi-people-fill"
                                                    viewBox="0 0 16 16">
                                                    <path
                ...
                <div class="flex-shrink max-w-full px-4 w-full">
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-6">
                        <div class="overflow-x-auto">
                            <table
                                class="table-bordered w-full ltr:text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                <thead>
                                    <tr>
                                        <th>
                                            Task Title
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="flex flex-wrap flex-row items-center">
                                                <div
                                                    class="leading-5 font-semibold dark:text-gray-300 flex-shrink max-w-full w-full mb-1">
                                        ...
                                        <td>
                                            <div
                                                class="text-sm text-center px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full">
                                                In progress</div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="text-sm text-center px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">
                                                Complete</div>
                                        </td>
                                        <td class="hidden lg:table-cell">
                            ...
                            <ol class="h-72 overflow-y-auto scrollbars show mb-6">
                                <li class="flex mb-2">
                                    <div class="relative flex-shrink-0 w-12 text-center">
                                        <span
                                            class="absolute ltr:left-1/2 rtl:right-1/2 ltr:-ml-1 rtl:-mr-1 top-10 -bottom-4 ltr:border-l-2 rtl:border-r-2 border-dashed border-gray-200 dark:border-gray-700"></span>
                                        <div class="mr-auto">
                                            <img src="../src/img/avatar/avatar3.png"
                                                class="h-10 w-10 rounded-full border border-gray-300 bg-gray-700 dark:border-gray-200 dark:bg-gray-200">
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full ml-4 mb-4">
                                        ...
                                        <p class="text-sm">Assigned task <span
                                                class="itaic font-semibold text-gray-500">"Create landing page design
                                                with Figma"</span></p>
                                    </div>
                                </li>
                                <li class="flex mb-2">
                                    ...
                                    <div class="w-full ml-4 mb-4">
                                        ...
                                        <p class="text-sm">Completed <span
                                                class="itaic font-semibold text-gray-500">"Convert Figma footer design
                                                to HTML file"</span></p>
                                    </div>
                                </li>
                                <li class="flex mb-2">
                                    <div class="relative flex-shrink-0 w-12 text-center">
                                        <span
                                            class="absolute ltr:left-1/2 rtl:right-1/2 ltr:-ml-1 rtl:-mr-1 top-10 -bottom-4 ltr:border-l-2 rtl:border-r-2 border-dashed border-gray-200 dark:border-gray-700"></span>
                                        <div class="mr-auto">
                                            <img src="../src/img/avatar/avatar6.png"
                                                class="h-10 w-10 rounded-full border border-gray-300 bg-gray-700 dark:border-gray-200 dark:bg-gray-200">
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full ml-4 mb-4">
                                        ...
                                        <p class="text-sm">Completed <span
                                                class="itaic font-semibold text-gray-500">"Fix bugs on Login page
                                                form"</span></p>
                                    </div>
                                </li>
                                <li class="flex mb-2">
                                    <div class="relative flex-shrink-0 w-12 text-center">
                                        <span
                                            class="absolute ltr:left-1/2 rtl:right-1/2 ltr:-ml-1 rtl:-mr-1 top-10 -bottom-4 ltr:border-l-2 rtl:border-r-2 border-dashed border-gray-200 dark:border-gray-700"></span>
                                        <div class="mr-auto">
                                            <img src="../src/img/avatar/avatar7.png"
                                                class="h-10 w-10 rounded-full border border-gray-300 bg-gray-700 dark:border-gray-200 dark:bg-gray-200">
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full ml-4 mb-4">
                                        ...
                                        <p class="text-sm">Assigned task <span
                                                class="itaic font-semibold text-gray-500">"Fix bugs on Comments
                                                form"</span></p>
                                    </div>
                                </li>
                                <li class="flex mb-2">
                                    <div class="relative flex-shrink-0 w-12 text-center">
                                        <span
                                            class="absolute ltr:left-1/2 rtl:right-1/2 ltr:-ml-1 rtl:-mr-1 top-10 -bottom-4 ltr:border-l-2 rtl:border-r-2 border-dashed border-gray-200 dark:border-gray-700"></span>
                                        <div class="mr-auto">
                                            <img src="../src/img/avatar/avatar2.png"
                                                class="h-10 w-10 rounded-full border border-gray-300 bg-gray-700 dark:border-gray-200 dark:bg-gray-200">
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full ml-4 mb-4">
                                        ...
                                        <p class="text-sm">Completed <span
                                                class="itaic font-semibold text-gray-500">"Redesign Services
                                                page"</span></p>
                                    </div>
                                </li>
                            </ol>
