                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                        ...
                        <div class="flex flex-col justify-center md:flex-row md:justify-between mb-3">
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" tabindex="0"
                                    class="z-50 overflow-auto inset-0 w-full h-full fixed py-6" style="display:none">
                                    <div class="z-50 relative p-3 mx-auto my-0 max-w-full" style="width: 600px;"
                                        ...
                                        <div
                                            class="bg-white dark:bg-gray-800 rounded shadow-lg border dark:border-gray-700 flex flex-col overflow-hidden">
                                            <button @click="open = false"
                                                class="fill-current h-6 w-6 absolute ltr:right-0 rtl:left-0 top-0 m-6 font-3xl font-bold">&times;</button>
                                            <!-- modal title -->
                                            <div
                                                class="px-6 py-3 text-xl border-b dark:text-gray-300 dark:border-gray-700 font-bold">
                                                Add new task</div>
                                            <!-- modal content -->
                                            <form id="pristinejs-form" class="py-4" action="kanban.html" novalidate
                                                method="post">
                                                <div class="px-6 flex-grow">
                                                    <div class="form-group mb-4">
                                                        <label for="exampleTextarea1"
                                                            class="inline-block mb-2">Description</label>
                                                        <textarea
                                                            class="w-full leading-5 relative py-3 px-5 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                                            id="exampleTextarea1" rows="3" minlength="10"
                                                            data-pristine-required-message="Please insert description"
                                                            required></textarea>
                                                    </div>
                                                </div>
                                                <div class="flex flex-wrap flex-row mb-4">
                                                    <div
                                                        class="form-group flex-shrink max-w-full px-6 w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        <label for="inputcategory"
                                                            class="inline-block mb-2">Category</label>
                                                    ...
                                                    <div
                                                        class="form-group flex-shrink max-w-full px-6 w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        <label for="inputUrgency"
                                                            class="inline-block mb-2">Urgency</label>
                                                    ...
                                                    <div
                                                        ...
                                                        <div id="datepicks" class="flex flex-row justify-between">
                                                            <input id="datepick"
                                                                ...
                                                                type="text" name="duedate" required>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="form-group flex-shrink max-w-full px-6 w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        ...
                                                        <input name="tags" value=""
                                                            class="tagify-select w-full leading-5 relative text-sm py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                                            id="inputAssigned" minlength="2">
                                                    </div>
                                                </div>

                                                <div class="pt-4 px-6 border-t dark:border-gray-700 flex justify-end">
                                                    <button @click="open = false"
                                                        class="py-2 px-4 inline-block text-center rounded leading-5 text-gray-800 bg-gray-100 border border-gray-100 hover:text-gray-900 hover:bg-gray-200 hover:ring-0 hover:border-gray-200 focus:bg-gray-200 focus:border-gray-200 focus:outline-none focus:ring-0 ltr:mr-2 rtl:ml-2 dark:bg-gray-300">Cancel</Button>

                                                    <button type="submit"
                                                        class="py-2 px-4 inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-800 focus:outline-none focus:ring-0">Add
                                                        task</Button>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="flex flex-grow space-x-6 overflow-y-hidden overflow-auto" style="height:34rem">
                            <div class="flex flex-col flex-shrink-0 w-72 overflow-y-auto" style="max-height:32rem">
                                <div
                                    class="flex flex-col py-2 px-4 bg-gray-200 text-gray-700 dark:bg-gray-900 dark:bg-opacity-40 dark:text-gray-300">
                                    <h3 class="text-base font-semibold">Backlog</h3>
                                </div>
                                <div
                                    class="flex flex-col pt-4 pb-6 px-4 bg-gray-50 dark:bg-gray-900 dark:bg-opacity-20 overflow-auto">
                                    <!-- item -->
                                    <div class="bg-pink-200 hover:bg-opacity-90 text-pink-900 relative flex flex-col items-start p-4 mb-4 rounded-lg cursor-pointer"
                                        draggable="true">
                                        <span
                                            class="flex items-center h-6 px-3 text-xs font-semibold text-pink-500 bg-pink-100 rounded-full">Development</span>
                                        ...
                                        <div class="flex justify-between items-center w-full mt-3 text-xs font-medium">
                                            <span
                                                class="px-2 py-1 flex items-center font-semibold text-xs rounded text-pink-400 border border-pink-400 bg-white">Due:
                                                15 Aug</span>
                                            <div class="relative">
                                                <a href="kanban.html#">
                                                    <img class="inline-block rounded-full shadow-xl w-8 h-8 max-w-full ltr:-mr-4 rtl:-ml-4 border-2 bg-gray-300 border-gray-200 transform hover:-translate-y-1"
                                    ...
                                    <!-- item -->
                                    <div class="bg-yellow-200 hover:bg-opacity-90 text-yellow-900 relative flex flex-col items-start p-4 mb-4 rounded-lg cursor-pointer"
                                        draggable="true">
                                        <span
                                            class="flex items-center h-6 px-3 text-xs font-semibold text-pink-500 bg-pink-100 rounded-full">Development</span>
                                        <h4 class="mt-3 text-sm font-medium">This is the description of the task for the
                                    ...
                                    <!-- item -->
                                    <div class="bg-green-200 hover:bg-opacity-90 text-green-900 relative flex flex-col items-start p-4 mb-4 rounded-lg cursor-pointer"
                                        draggable="true">
                                        <span
                                            class="flex items-center h-6 px-3 text-xs font-semibold text-pink-500 bg-pink-100 rounded-full">Development</span>
                                        <h4 class="mt-3 text-sm font-medium">This is the description of the task for the
