...
<body class="font-sans text-base font-normal text-gray-600 dark:text-gray-400 pt-20 bg-indigo-600 bg-gradient-to-r from-indigo-800 via-indigo-700 to-green-500 dark:from-gray-800 dark:via-gray-700 dark:to-green-700 dark:from-gray-800 dark:via-gray-700 dark:to-green-700 ">
  <!-- preloader -->
      ...
      <div class="container mx-auto px-4 xl:max-w-6xl ">
        ...
        <div class="flex flex-row justify-between py-4">
          ...
          <div class="flex items-center">
            <p class="self-center font-bold text-white pr-8">(+123) 456 7890</p>
          </div>
        </div>
      </div>
    </nav><!-- End Navbar -->
          ...
          <div class="flex-shrink max-w-full px-4 w-full md:w-9/12 lg:w-1/2 self-center lg:pr-12">
            <div class="text-center lg:ltr:text-left lg:rtl:text-right mt-6 lg:mt-0">
              <div class="mb-6">
                ...
                <p class="text-gray-400 leading-relaxed font-light text-xl mx-auto pb-2">We're making the system more awesome. We'll be back shortly. If you have any questions, please contact us.</p>
              </div>
  ...
  <div x-data="{ open: false }" class="relative">
    <a href="javascript:;" class="fixed bottom-4 ltr:right-4 rtl:left-4 text-gray-300 block py-3 px-4 flex text-sm rounded-full focus:outline-none" aria-controls="mobile-canvas" @click="open = !open" aria-expanded="false" x-bind:aria-expanded="open.toString()">
