            ...
            <div class="flex flex-wrap flex-row">
                ...
                <div class="flex-shrink max-w-full px-4 w-full mb-6">
                                    ...
                                    <div class="flex">
                                        <button @click="open = true" type="button"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1 bi bi-plus"
                                                viewBox="0 0 16 16">
                                                <path
                                                ...
                                                <form action="calendar.html#">
                                                    <div class="p-6 flex-grow">
                                                        <div class="mb-6">
                                                            <label for="exampleInput1"
                                                                class="inline-block mb-2">Title</label>
                                                            <input type="text"
                                                        ...
                                                        <div class="mb-6">
                                                            <label for="rangetime" class="inline-block mb-2">Start and
                                                                End date</label>
                                                            <div id="rangetime"
                                                        ...
                                                        <div class="mb-6">
                                                            <label class="flex items-center">
                                                                <input type="checkbox" name="checked-demo" value="1"
                                                                    class="form-checkbox text-indigo-500 h-5 w-5 border border-gray-300 dark:border-gray-700 dark:focus:border-gray-600 dark:bg-gray-700 rounded focus:outline-none ltr:mr-2 rtl:ml-2">
                                                                <span>All Day</span>
                                                            </label>
                                                        </div>
                                                        <div class="mb-6">
                                                            <label for="exampleLink" class="inline-block mb-2">With
                                                                Link</label>
                                                            <input type="text"
                                                                class="w-full leading-5 relative text-sm py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                                                id="exampleLink" placeholder="https://">
                                                        </div>
                                                        <div class="mb-6">
                                                    ...
                                                    <div
                                                        ...
                                                        <button @click="open = false" type="button"
                                                            class="ltr:mr-2 rtl:ml-2 py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-pink-500 border border-pink-500 hover:text-white hover:bg-pink-600 hover:ring-0 hover:border-pink-600 focus:bg-pink-600 focus:border-pink-600 focus:outline-none focus:ring-0">Close</Button>
                                                        <button type="submit"
                                                            class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">Save</Button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                    ...
                    <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                        <div class="relative">
                            <p class="text-lg mb-3 font-light">For the event calendar we use the fullcalendar plugin,
                                this is a popular plugin for creating event schedules.</p>
                            <h2 class="text-lg mb-4 font-semibold text-gray-800 dark:text-gray-300">How to install ?
                            </h2>
                            <pre class="mb-8">
...
&lt;/script&gt;
                            ...
                            <p class="mb-4">Demo config available in <code class="text-pink-700">src/js/vendor.js</code>
                                function <code class="text-pink-700">myCalendar();</code></p>
                    ...
                    <code class="language-html" data-lang="html">
                    	&lt;div id="calendar"&gt;&lt;/div&gt;
                            ...
                            <p class="mb-4 font-light">For more documentation please check in here <a target="_blank"
                                    href="https://github.com/fullcalendar/fullcalendar"
                                    class="text-blue-500 hover:underline">https://github.com/fullcalendar/fullcalendar</a>.
                        </div>
                    </div>
                </div>
            </div>
