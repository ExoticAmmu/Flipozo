                                    ...
                                    <table
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <a href="order.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img
                                                                    class="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600"
                                                                    src="../src/img/avatar/avatar2.png"></div>
                                                            <div
                                                ...
                                                <td>
                                                    <a href="order.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img
                                                                    class="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600"
                                                                    src="../src/img/avatar/avatar3.png"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                                                John doe
                                                            </div>
                                            ...
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <td>
                                                    <a href="order.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img
                                                                    class="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600"
                                                                    src="../src/img/avatar/avatar4.png"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                                                John doe
                                                            </div>
                                                ...
                                                <td class="hidden lg:table-cell">
                                                    <span
                                                        class="text-sm px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">Complete</span>
                                                </td>
                                                <td class="text-center">165$</td>
                                                <td class="text-center">
                                                    <a href="javascript:;"
                                                ...
                                                <td>
                                                    <a href="order.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img
                                                                    class="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600"
                                                                    src="../src/img/avatar/avatar5.png"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                                                John doe
                                                            </div>
                                            ...
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <td>
                                                    <a href="order.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img
                                                                    class="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600"
                                                                    src="../src/img/avatar/avatar6.png"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                                                John doe
                                                            </div>
                                                ...
                                                <td class="hidden lg:table-cell">
                                                    <span
                                                        class="text-sm px-2 py-1 font-semibold leading-tight text-indigo-700 bg-indigo-100 rounded-full">Shipped</span>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="order.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img
                                                                    class="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600"
                                                                    src="../src/img/avatar/avatar8.png"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                                                John doe
                                                            </div>
                                            ...
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <td class="hidden lg:table-cell">
                                                    <span
                                                        class="text-sm px-2 py-1 font-semibold leading-tight text-pink-700 bg-pink-100 rounded-full">Canceled</span>
                                                </td>
                                                <td class="text-center">35$</td>
                                                <td class="text-center">
                                                    <a href="javascript:;"
