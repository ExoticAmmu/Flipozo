                            ...
                            <table class="table-auto w-full ltr:text-left rtl:text-right text-gray-600">
                                ...
                                <tbody>
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="p-4 font-normal text-center hidden lg:table-cell">
                                            <div class="flex flex-row" style="max-width: 200px;">
                                                <input type="text" name="quantity[456]" value="1" size="1"
                                                    class="ltr:rounded-l rtl:rounded-r leading-5 relative py-2 px-4 text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600">
                                                <span class="flex flex-row">
                                                    <button type="submit"
                                                        class="py-2 px-4 inline-block text-center py-2 px-4 inline-block text-center rounded-0 leading-normal text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-gray-100 hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                                                        title="Update">
                                                    ...
                                                    <button type="button" onclick="cart.remove('456');"
                                                        class="py-2 px-4 inline-block text-center ltr:rounded-r rtl:rounded-l leading-normal text-gray-100 bg-pink-500 border border-pink-500 hover:text-white hover:bg-pink-600 hover:ring-0 hover:border-pink-600 focus:bg-pink-600 focus:border-pink-600 focus:outline-none focus:ring-0"
                                                        title="Remove">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="p-4 font-normal text-center hidden lg:table-cell">
                                            <div class="flex flex-row" style="max-width: 200px;">
                                                <input type="text" name="quantity[456]" value="3" size="1"
                                                    class="ltr:rounded-l rtl:rounded-r leading-5 relative py-2 px-4 text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600">
                                                <span class="flex flex-row">
                                                    <button type="submit"
                                                        class="py-2 px-4 inline-block text-center py-2 px-4 inline-block text-center rounded-0 leading-normal text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-gray-100 hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                            ...
                            <div class="flex flex-wrap flex-row">
                                ...
                                <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 table-custom">
                                    <table class="table-auto w-full ltr:text-left rtl:text-right text-gray-600">
                                        <tbody>
                                            <tr class="border-b dark:border-gray-700">
                                                <td colspan="4"></td>
                                                <td
                                                    class="p-4 font-normal text-center md:ltr:text-right md:rtl:text-left">
                                                    <b>Sub-Total</b></td>
                                                <td
                                                    class="p-4 font-normal text-center md:ltr:text-right md:rtl:text-left totals">
                                                    $290</td>
                                            </tr>
                                            <tr class="border-b dark:border-gray-700">
                                                <td colspan="4"></td>
                                    ...
                                    <div class="pt-4 w-full ltr:text-right rtl:text-left">
                                        <a href="cart.html#"
                                            class="py-2 px-4 inline-block text-center mb-3 rounded py-2 px-4 inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-gray-100 hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">
                                            Checkout Now <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor"
