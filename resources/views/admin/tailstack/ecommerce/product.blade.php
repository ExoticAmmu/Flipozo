                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
                                                <th data-sortable="false"><input id="checkall" type="checkbox"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="line-through mr-2">$97</span><span
                                                        class="text-green-500">79$</span></td>
                                                <td class="text-center hidden lg:table-cell">1256</td>
                                                <td class="hidden lg:table-cell"><span
                                                        class="text-sm px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">In
                                                        stock</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="product.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img class="h-8 w-8"
                                                                    src="../src/img/products/product3.jpg"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="product.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img class="h-8 w-8"
                                                                    src="../src/img/products/product4.jpg"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                                ...
                                                <td class="hidden lg:table-cell"><span
                                                        class="text-sm px-2 py-1 font-semibold leading-tight text-gray-700 bg-gray-100 rounded-full">Not
                                                        active</span></td>
                                                <td class="text-center">
                                                    <a href="javascript:;"
                                                        class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="product.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img class="h-8 w-8"
                                                                    src="../src/img/products/product5.jpg"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="product.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img class="h-8 w-8"
                                                                    src="../src/img/products/product6.jpg"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                                ...
                                                <td class="text-center hidden lg:table-cell">0</td>
                                                <td class="hidden lg:table-cell"><span
                                                        class="text-sm px-2 py-1 font-semibold leading-tight text-pink-700 bg-pink-100 rounded-full">Out
                                                        stock</span></td>
                                                <td class="text-center">
                                                    <a href="javascript:;"
                                                        class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="product.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img class="h-8 w-8"
                                                                    src="../src/img/products/product7.jpg"></div>
                                                            <div
                                                                class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden lg:table-cell"><span
                                                        class="text-sm px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full">Low
                                                        stock</span></td>
                                                <td class="text-center">
                                                    <a href="javascript:;"
                                                        class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500"
