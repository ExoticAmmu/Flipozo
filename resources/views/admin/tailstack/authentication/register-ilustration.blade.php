	              ...
	              <div class="p-6 sm:py-8 sm:px-12 rounded-lg bg-white dark:bg-gray-800 shadow-xl">
	                <form id="register-form">
			            	<div class="text-center">
				              <h1 class="text-2xl leading-normal mb-3 font-bold text-gray-800 dark:text-gray-300 text-center">Join Now</h1>
								    </div>
			              ...
			              <div class="mt-6 mb-4">
		                    ...
		                    <label class="ltr:ml-2 rtl:mr-2" for="terms">
		                      I agree to the <a href="register-ilustration.html#">Terms and Conditions</a>
		                    </label>
		                  </div>
			              <div class="grid">
			            ...
			            <div class="mt-4">
			              ...
			              <div class="text-center mb-6 sm:space-x-4">
			                <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-900 border border-indigo-900 hover:text-white hover:opacity-90 hover:ring-0 hover:border-indigo-900 focus:bg-indigo-900 focus:border-indigo-800 focus:outline-none focus:ring-0 mb-3" href="register-ilustration.html#">
			              ...
			              <p class="text-center mb-4">Already have an account?  <a class="hover:text-indigo-700" href="login-ilustration.html">Login</a></p>
			            </div>
			          </div>
			        </div>
			      </div>
      ...
      <div class="mx-auto px-4">
        <div class="flex flex-wrap flex-row -mx-4">
          <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 text-center md:ltr:text-left md:rtl:text-right">
                ...
                <a class="hover:text-indigo-500" href="register-ilustration.html#">Support</a>
              </li>
              
                <a class="hover:text-indigo-500" href="register-ilustration.html#">Help Center</a>
              </li>
              
                <a class="hover:text-indigo-500" href="register-ilustration.html#">Privacy</a>
              </li>
              
                <a class="hover:text-indigo-500" href="register-ilustration.html#">Terms of Service</a>
              </li>
            </ul>
          </div>
