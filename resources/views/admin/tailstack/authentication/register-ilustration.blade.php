                                ...
                                <div class="p-6 sm:py-8 sm:px-12 rounded-lg bg-white dark:bg-gray-800 shadow-xl">
                                    <form id="register-form">
                                        <div class="text-center">
                                            <h1 class="text-2xl leading-normal mb-3 font-bold text-gray-800 dark:text-gray-300 text-center">
                                                Join Now</h1>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <label for="inputrepeatpass" class="inline-block mb-2">Repeat
                                                Password</label>
                                        ...
                                        <div class="mt-6 mb-4">
                                            ...
                                            <label class="ltr:ml-2 rtl:mr-2" for="terms">
                                                I agree to the <a href="register-ilustration.html#">Terms and
                                                    Conditions</a>
                                            </label>
                                        </div>
                                        <div class="grid">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="text-center mb-6 sm:space-x-4">
                                            <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-900 border border-indigo-900 hover:text-white hover:opacity-90 hover:ring-0 hover:border-indigo-900 focus:bg-indigo-900 focus:border-indigo-800 focus:outline-none focus:ring-0 mb-3" href="register-ilustration.html#">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4 mx-1" fill="currentColor" viewBox="0 0 512 512">
                                        ...
                                        <p class="text-center mb-4">Already have an account? <a class="hover:text-indigo-700" href="login-ilustration.html">Login</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
