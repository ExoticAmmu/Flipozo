                            ...
                            <div class="p-6 sm:py-8 sm:px-12 rounded-lg bg-white dark:bg-gray-800 shadow-xl">
                                <form id="login-form">
                                    ...
                                    <div class="mb-6">
                                        <input
                                            class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                            placeholder="Password" aria-label="password" type="password" value=""
                                            required="">
                                    </div>
                                    <div class="mb-6">
                                        <input
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="text-center mb-4 sm:space-x-4">
                                        <a class="py-2 px-4 block sm:inline-block rounded leading-5 text-gray-100 bg-indigo-900 border border-indigo-900 hover:text-white hover:opacity-90 hover:ring-0 hover:border-indigo-900 focus:bg-indigo-900 focus:border-indigo-800 focus:outline-none focus:ring-0 mb-3"
                                            href="login-basic.html#">
                                            <!-- <i class="fab fa-facebook"></i> -->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="ltr:mr-2 rtl:ml-2 inline-block w-4 h-4" fill="currentColor"
                                                viewBox="0 0 512 512">
                                                <path
                                        ...
                                        <a class="py-2 px-4 block sm:inline-block rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0 mb-3"
                                            href="login-basic.html#">
                                    ...
                                    <p class="text-center mb-4">Don't have an account? <a class="hover:text-indigo-500"
                                            href="register-basic.html">Register</a></p>
                                    <p class="text-center"><a class="hover:text-indigo-500"
                                            href="forgot-password.html">Lost password?</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
