                            ...
                            <div class="mb-12">
                                ...
                                <div class="bg-white p-8 border border-gray-200 dark:bg-gray-800 dark:border-gray-800">
                                    <table class="table-auto w-full">
                                        <thead
                                            class="bg-gray-100 border-t border-l border-r dark:bg-gray-900 dark:bg-opacity-40 dark:border-gray-700">
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    class="border border-gray-200 px-4 py-3 dark:border-gray-700 font-medium">
                                                    Intro to CSS</td>
                                                <td
                                                    class="border border-gray-200 px-4 py-3 dark:border-gray-700 font-medium">
                                                    Adam</td>
                      ...
                      <code class="language-html" data-lang="html">
                        ...
                        &lt;/table&gt;
                            ...
                            <div class="mb-12">
                                ...
                                <div class="bg-white p-8 border border-gray-200 dark:bg-gray-800 dark:border-gray-800">
                                    <table
                                        class="table-sm table-bordered-bottom w-full ltr:text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        <thead>
                                            <tr class="bg-gray-200 dark:bg-gray-900 dark:bg-opacity-40">
                                                <th>Title</th>
                                                <th>Author</th>
                            ...
                            <div class="mb-12">
                                ...
                                <div class="bg-white p-8 border border-gray-200 dark:bg-gray-800 dark:border-gray-800">
                                    <div class="hidden-header hidden-sort-after">
                                        <table
                                            class="table-sorter table-sm text-sm table-bordered-bottom w-full ltr:text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                            <thead>
                                                <tr class="bg-gray-200 dark:bg-gray-900 dark:bg-opacity-40">
                                                    <th>Title</th>
                                                    <th>Author</th>
                      ...
                      <code class="language-html" data-lang="html">
                        ...
                        &lt;/div&gt;
                                    ...
                                    <p class="mb-4">Demo config available in <code
                                            ...
                                            class="text-pink-700">myTablesorter();</code></p>
                                </div>
                            </div>
                        </div>
                    </div>
