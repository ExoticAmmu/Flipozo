                    ...
                    <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="bg-white p-8 border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                                    ...
                                    <h6 class="text-lg leading-normal mb-2 font-bold text-gray-800 dark:text-gray-300">
                                        H5</h6>
                                    <h6
                                        class="text-base leading-normal mb-2 font-bold text-gray-800 dark:text-gray-300">
                                        H6</h6>
                                </div>
                                <pre>
                      <code class="language-html" data-lang="html">
                        ...
                        &lt;h6 class="text-base leading-normal mb-2 font-bold text-gray-800 dark:text-gray-300"&gt;H6&lt;/h6&gt;
                                ...
                                <p class="my-6">Heading also can change with <code
                                        class="text-pink-700">&lt;p class="..."&gt;</code></p>
                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="bg-white p-8 border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                                    <a href="typography.html#" class="text-indigo-500 hover:underline">Click this
                                        link</a><br>
                                    <a href="typography.html#" target="_blank" rel="noopener"
                                        class="text-indigo-500 hover:underline">External link</a>
                                </div>
                                <pre>
                      <code class="language-html" data-lang="html">
                      ...
                      <code class="language-html" data-lang="html">
                        &lt;p class="text-gray-500"&gt;Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor&lt;/p&gt;
                            ...
                            <div class="mb-8">
                                ...
                                <div class="bg-white p-8 border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                                    <blockquote
                                        class="relative p-4 ltr:border-l-4 rtl:border-r-4 border-blue-700 bg-gray-100 dark:bg-gray-700 mb-4 text-xl">
                                        ...
                                        <footer class="ltr:ml-16 rtl:mr-16 text-base">Quote by <cite
                                                title="Source Title">Ari Budin</cite></footer>
                                    </blockquote>
                                </div>
                                <pre>
                      <code class="language-html" data-lang="html">
                        ...
                        &lt;/blockquote&gt;
                            ...
                            <div class="mb-8">
                                ...
                                <div class="bg-white p-8 border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                                    <p><span
                                            class="block ltr:float-left rtl:float-right text-6xl ltr:mr-3 rtl:ml-3 mb-3 text-center">A</span>enean
