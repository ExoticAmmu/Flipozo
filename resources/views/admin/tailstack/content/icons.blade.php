                        ...
                        <div class="relative">
                            <div class="mb-6">
                                ...
                                <p class="text-lg mb-b font-light">Actually, we have many reasons, for more details,
                                    please read the comparison article between svg vs font icon <a target="_blank"
                                        href="https://www.lambdatest.com/blog/its-2019-lets-end-the-debate-on-icon-fonts-vs-svg-icons/"
                                        class="text-blue-500">in here</a>.</p>
                                ...
                                <!-- example -->
                                <div
                                    class="bg-gray-100 dark:bg-gray-700 dark:border-gray-700 p-8 mb-6 border border-gray-200">
                      ...
                      <code class="language-html" data-lang="html">
                        ...
                        &lt;/svg&gt;&lt;!-- &lt;i class="fas fa-home"&gt;&lt;/i&gt; --&gt;
                                ...
                                <a href="https://icons.getbootstrap.com/" target="_blank"
                                    class="block text-lg mb-2 font-light text-blue-500">Bootstrap Icons</a>
                                <a href="https://ionic.io/ionicons" target="_blank"
                                    class="block text-lg mb-6 font-light text-blue-500">Ionicons</a>

                                <h2 class="text-lg mb-3 font-semibold text-gray-800 dark:text-gray-300">Recommendation
                                    Font icon</h2>
                                <a href="https://fontawesome.com/" target="_blank"
                                    class="block text-lg mb-2 font-light text-blue-500">Fontawesome</a>
                            </div>
                        </div>
                    </div>
                </div>
