                        ...
                        <div class="relative">
                            ...
                            <header class="text-center mx-auto mb-12">
                                <h1 class="text-2xl leading-normal mb-2 font-bold text-gray-800 dark:text-gray-300">
                                    <span class="font-light">Our</span> Services</h1>
                            ...
                            <div class="flex flex-wrap flex-row -mx-4 text-center">
                                <div class="flex-shrink max-w-full px-4 w-full sm:w-1/2 xl:w-1/3">
                                    ...
                                    <div class="px-4 mb-12">
                                        <div
                                            class="relative w-20 h-20 mx-auto text-indigo-500 p-6 bg-gray-50 rounded-lg border border-gray-100 dark:bg-gray-900 dark:bg-opacity-40 dark:border-gray-700 mb-6">
                                            <!-- icon -->
                                            <div
                                                class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="32"
                                                    height="32" viewBox="0 0 512 512">
                                                    <rect stroke="currentColor" x="32" y="64" width="448" height="320"
                                                        rx="32" ry="32"
                                                    ...
                                                    <line stroke="currentColor" x1="368" y1="448" x2="144" y2="448"
                                    ...
                                    <div class="px-4 mb-12">
                                        <div
                                            ...
                                            <div
                                                class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="inline-block"
                                                    width="2rem" height="2rem" viewBox="0 0 512 512">
                                                    <path fill="currentColor"
                                    ...
                                    <div class="px-4 mb-12">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="inline-block"
                                                    width="2rem" height="2rem" viewBox="0 0 512 512">
                                                    <rect stroke="currentColor" x="128" y="16" width="256" height="480"
                                                        rx="48" ry="48"
                                                        style="fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px" />
