                    ...
                    <div class="p-12 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                        <div class="relative">
                            <header class="text-center mx-auto mb-6">
                                <h1 class="text-4xl leading-normal mb-2 font-bold text-gray-800 dark:text-gray-300">404
                                    <span class="font-light">Not Found</span></h1>
                                <hr class="block w-12 h-0.5 mx-auto my-5 bg-indigo-500 border-indigo-500">
                                <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">That page can't
                                    be found. It looks like nothing was found at this location.</p>
                            </header>
                            <div class="relative text-center">
                                ...
                                <a href="index.html"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem"
                                        fill="currentColor" class="bi bi-house-door inline-block ltr:mr-2 rtl:ml-2"
                                        viewBox="0 0 16 16">
                                        <path
