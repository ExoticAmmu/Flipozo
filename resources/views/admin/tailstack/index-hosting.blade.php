        ...
        <div class="mx-auto p-2">
            ...
            <div class="flex flex-wrap flex-row">
                ...
                <div class="flex-shrink max-w-full px-4 w-full lg:w-1/3">
                    ...
                    <a
                        class="text-sm py-2 px-4 block text-center mb-6 rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">Top
                        up</a>
                            ...
                            <ol class="h-72 overflow-y-auto scrollbars show mb-6">
                                <li class="flex mb-2">
                                    <div class="relative flex-shrink-0 w-12 text-center">
                                        <span
                                            class="absolute ltr:left-1/2 ltr:-ml-1 rtl:right-1/2 rtl:-mr-1 top-10 -bottom-4 ltr:border-l-2 rtl:border-r-2 border-dashed border-gray-200 dark:border-gray-700"></span>
                                        <div class="ltr:mr-auto rtl:ml-auto">
                                            <div
                                                class="flex items-center justify-center text-indigo-500 h-10 w-10 rounded-full border border-gray-200 bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:bg-opacity-40">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <li class="flex mb-2">
                                    ...
                                    <div class="ltr:ml-4 rtl:mr-4 mb-4">
                                        ...
                                        <p class="text-sm">Order domain <span
                                                class="font-semibold">"Mydomain.com"</span></p>
                                    </div>
                                </li>
                                <li class="flex mb-2">
                                    <div class="relative flex-shrink-0 w-12 text-center">
                                    ...
                                    <div class="ltr:ml-4 rtl:mr-4 mb-4">
                                        ...
                                        <p class="text-sm">Order domain <span
                                                class="font-semibold">"Bestdomain.com"</span></p>
                                    </div>
                                </li>
                                <li class="flex mb-2">
                                    <div class="relative flex-shrink-0 w-12 text-center">
                                        ...
                                        <div class="ltr:mr-auto rtl:ml-auto">
                                            <div
                                                class="flex items-center justify-center text-indigo-500 h-10 w-10 rounded-full border border-gray-200 bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:bg-opacity-40">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-hdd-stack" viewBox="0 0 16 16">
                                                    <path
                                                        d="M14 10a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h12zM2 9a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H2z">
                                                    </path>
                                                    <path
                                ...
                                <table class="table-sorter table-bordered-bottom w-full">
                                    ...
                                    <tbody class="text-sm leading-5">
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="inline-block leading-tight text-center text-sm font-semibold py-1 px-3 bg-green-100 text-green-700 dark:bg-opacity-80 rounded-full">
                                                    Active</div>
                                            </td>
                                            <td>
                                                <a href="index-hosting.html#"
                                                    class="text-sm py-2 px-3 text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="inline-block leading-tight text-center text-sm font-semibold py-1 px-3 bg-yellow-100 text-yellow-700 dark:bg-opacity-80 rounded-full">
                                                    Pending</div>
                                            </td>
                                            <td>
                                                <a href="index-hosting.html#"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="inline-block leading-tight text-center text-sm font-semibold py-1 px-3 bg-pink-100 text-pink-700 dark:bg-opacity-80 rounded-full">
                                                    Canceled</div>
                                            </td>
                                            <td>
                                                <a href="index-hosting.html#"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="inline-block leading-tight text-center text-sm font-semibold py-1 px-3 bg-gray-100 text-gray-700 dark:bg-opacity-80 rounded-full">
                                                    Expired</div>
                                            </td>
                                            <td>
                                                <a href="index-hosting.html#"
