...
&lt;/div&gt;
                    ...
                    <p class="text-lg mb-6 font-light">Editing id value and configuration with javascript, please
                        see example in demo.js. Read complete documentation in <a href="https://flatpickr.js.org/getting-started/" target="_blank" class="text-blue-500">https://flatpickr.js.org/getting-started/</a>
                </div>
            </div>
        </div>
    </div>
