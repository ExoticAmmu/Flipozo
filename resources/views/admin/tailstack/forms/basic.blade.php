        ...
        <div class="p-8 mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <div class="relative">
            ...
            <div class="p-6 mb-6 border border-gray-200 bg-gray-100 dark:bg-gray-900 dark:border-gray-800 dark:bg-opacity-20">
              ...
              <div class="flex flex-wrap items-stretch w-full relative mb-6">
                <span class="flex items-center py-2 px-4 ltr:-mr-1 rtl:-ml-1 ltr:rounded-l rtl:rounded-r leading-5  bg-gray-100 border border-gray-300 dark:bg-gray-900 dark:border-gray-900">With
                  textarea</span>
