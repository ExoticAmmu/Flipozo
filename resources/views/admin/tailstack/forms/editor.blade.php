            ...
            <div class="flex flex-wrap flex-row">
                ...
                <div class="flex-shrink max-w-full px-4 w-full mb-6">
                    <div class="p-8 mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                        <div class="relative">
                            <p class="text-lg mb-6 font-light">A simple, beautiful, and embeddable JavaScript Markdown
                                editor.</p>
                        </div>
                        <style>
                        .editor-preview h1,
                        ...
                        <div class="relative">
                            <div class="mb-0">
                                ...
                                <textarea
                                    class="texteditor w-full leading-5 relative py-3 px-5 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                    id="texteditor" rows="3"></textarea>
                            </div>
                        </div>
...
&lt;/script&gt;
                        ...
                        <p class="mt-6 mb-6">Demo config available in <code
                                class="text-pink-700">src/js/vendor.js</code> function <code
                                class="text-pink-700">myEditor();</code></p>
                        <h3 class="text-lg mb-3 font-light">HTML Content</h3>
                        <p class="text-lg mb-6 font-light">Please add <code class="text-pink-700">post-content</code>
                            classes in where you want to paste post content.</p>
                        <code class="language-html" data-lang="html">
              &lt;div class="mb-6 post-content"&gt;
              &lt;!-- paste content on here --&gt;
              &lt;/div&gt;
            </code>
                        <p class="mt-6">More information about SimpleMDE please read <a target="_blank"
                                href="https://simplemde.com/" class="text-indigo-500">on here</a>
                        </p>
                    </div>
                </div>
            </div>
