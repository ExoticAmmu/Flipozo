            ...
            <div class="flex flex-wrap flex-row">
                ...
                <div class="flex-shrink max-w-full px-4 w-full mb-6">
                    <div class="p-8 mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                        <div class="relative">
                            <p class="text-lg mb-6 font-light">Upload any files with drag and drop features with
                                Dropzone. Dropzone is an easy to use drag'n'drop library. It supports image previews and
                                shows nice progress bars.</p>
                            <!-- Example input -->
                            <div
                    ...
                    &lt;/div&gt;
                            ...
                            <p class="my-4">Demo config available in <code class="text-pink-700">src/js/vendor.js</code>
                                function <code class="text-pink-700">myUploader();</code></p>
                            <p class="mt-6">More information about Dropzone please read <a target="_blank"
                                    href="https://github.com/dropzone/dropzone" class="text-indigo-500">on here</a>
                        </div>
                    </div>
                </div>
            </div>
