                    ...
                    <div class="flex flex-wrap flex-row -mx-4">
                        <div class="flex-shrink max-w-full px-4 w-full">
                            <div class="md:flex md:justify-between">
                                <div>
                                    <a href="product.html#" class="py-2 px-4 mb-3 block lg:inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">Add
                                ...
                                <table class="table-sorter table-bordered w-full ltr:text-left rtl:text-right text-gray-600 dark:text-gray-400">
                                    ...
                                    @foreach ( $products as $product )
                                        <tr>
                                            ...
                                            <td class="text-center"><span class="line-through mr-2">{{ $product->regular_price }}</span><span class="text-green-500">{{ $product->sale_price }}</span></td>
                                            <td class="text-center hidden lg:table-cell">{{ $product->quantity }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{route('admin.products.edit', ['id'=>$product->id] )}}" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-green-500" title="Edit">
                                                ...
                                                <a href="{{route('admin.products.destroy', $product->id)}}" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
