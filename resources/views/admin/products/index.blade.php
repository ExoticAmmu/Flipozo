                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                    ...
                                                    <a href="product.html#">
                                                        <div class="flex flex-wrap flex-row items-center">
                                                            <div class="self-center"><img class="h-8 w-8"
                                                                    src="/img/products/product1.jpg"></div>
                                                            <div
                                                ...
                                                <td class="text-center"><span
                                                        class="line-through mr-2">{{ $product->regular_price }}</span><span
                                                        class="text-green-500">{{ $product->sale_price }}</span></td>
                                                <td class="text-center hidden lg:table-cell">{{ $product->quantity }}
                                                </td>
