    ...
    <div class="mx-auto p-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">Admin Profile</p>
            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full p-6">
                            <div class="flex flex-row justify-between pb-3">
                                <div class="flex flex-col">
                                    <h3 class="text-base font-bold">Profile</h3>
                                </div>
                            ...
                            <div class="flex relative">
                                <a @click="open = true" class="z-30 group" href="javascript:;">
                                    <img src="/img/avatar/avatar.png"
                                        class="rounded-full w-24 h-24 bg-gray-200 border-solid border-white border-2 ">
