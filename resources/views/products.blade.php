                    ...
                    <div class="container mx-auto px-6 py-3">
                        ...
                        <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                            <div class="flex flex-col sm:flex-row">
                                ...
                                <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="/cart">Cart</a>
                                <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="/checkout">Checkout</a>
                    ...
                    <div class="container mx-auto px-6">
                        <div class="w-full px-4">
                            <ul class="flex flex-wrap items-center mb-4">
                                ...
                                <li><a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#">{{$products->slug}}</a></li>
                            </ul>
                        </div>
                        <div class="md:flex md:items-center">
                            <div class="md:w-2/5 h-64 sm:w-1/2 lg:h-96">
                                <img class="h-full w-full rounded-md object-cover mx-auto" src="https://images.unsplash.com/photo-1578262825743-a4e402caab76?ixlib=rb-1.2.1&auto=format&fit=crop&w=1051&q=80" alt="Nike Air">
                            </div>
                            <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                                <h3 class="text-gray-700 uppercase text-lg">{{$products->name}}</h3>
                                <span class="text-gray-500 mt-3">${{$products->regular_price}}</span>
                                <p class="text-lg text-gray-400">{{$products->short_description}}</p>
                                <hr class="my-3">
                                <form action="{{ url('add-to-cart')}}" method="POST">
                                    @csrf
                                    <div class="mt-2 mb-2">
                                    <label class="text-gray-700 text-sm" for="count">Quantity:</label>
                                    <input name="product_quantity" type="number" id="">
                                    <!-- <div class="flex" x-data="{count : 1}">
                                        <button type="button" class="border px-3 self-center cursor-pointer focus:ring ring-gray-700" @click="count++">
                                ...
                                <div class="flex items-center mt-6">
                                        <!-- <a href=" {{route('add-cart', [$products->id])}} " class="bg-white shadow hover:bg-gray-200 text-black text-center py-2 px-4 rounded">
                                            Add to Cart
                                        </a> -->
                                        <button type="submit" class="text-purple-500 bg-transparent text-sm border border-solid border-purple-500 hover:bg-purple-500 hover:text-white active:bg-pink-600 uppercase px-3 py-2 rounded outline-none focus:outline-none mr-1 mb-1" type="button" style="transition: all .15s ease">
                                                Add To Cart
                                            </button>
