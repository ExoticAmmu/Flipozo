                ...
                <div class="container mx-auto px-6">
                    <div class="mt-16">
                        ...
                        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                            ...
                            <div class="shadow border-l-4 border-purple-700 flex flex-row sm:flex-col bg-white rounded mb-1 ">
                                <a href="{{ url('product/'.$item->slug) }}">
                                    <img class=" h-60 w-full sm:h-60 sm:w-full rounded-tl-sm rounded-bl-sm" src="https://cdn.shopify.com/s/files/1/0533/2089/files/placeholder-images-product-5_large.png" alt="">
                                    <div class="p-4 w-full flex flex-col sm:space-y-3 justify-between ">
                                        ...
                                        <div class="flex justify-between items-center">
                                            <h4 class="text-lg font-semibold">{{ $item ->regular_price}}</h4>
                                            <div class="flex">
